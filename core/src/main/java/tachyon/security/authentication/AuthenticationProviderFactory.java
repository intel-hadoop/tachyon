...
public class AuthenticationProviderFactory {
  ...
  public static class AnonymousAuthenticationProviderImpl implements AuthenticationProvider {
  ...
  public static class CustomAuthenticationProviderImpl implements AuthenticationProvider {

    @Override
    public void authenticate(String user, String password) throws AuthenticationException {
      // TODO: get customized provider and invoke its auth method.
    }
  }
